...
import type { ShareChatHistoryItemType, ShareChatType } from '/common/global/support/outLink/api.d';
import type { ChatSiteItemType } from '/common/global/core/chat/type.d';
