    ...
    <Box>
      ...
      <Grid px={[5, 0]} minH={'400px'} gridTemplateColumns={['1fr', `500px 1fr`]} gridGap={6}>
        ...
        >
          ...
          <MyImage
            src={`${process.env.BASE_PATH}/imgs/home/ai_assiatant.png`}
            alt={''}
        ...
        >
          ...
          <MyImage
            src={`${process.env.BASE_PATH}/imgs/home/dataset_import.png`}
            w={'90%'}
            mx={'auto'}
            borderRadius={'lg'}
          />
      ...
      >
        <Box {...CardStyles} backgroundImage={'linear-gradient(to top, #6a85b6 0%, #bac8e0 100%)'}>
          ...
          <MyImage
            src={`${process.env.BASE_PATH}/imgs/home/advanced_settings.png`}
            alt={''}
            w={'100%'}
          />
        </Box>
        ...
        >
          ...
          <MyImage
            src={`${process.env.BASE_PATH}/imgs/home/openapi.png`}
            alt={''}
            w={'90%'}
            mx={'auto'}
            borderRadius={'lg'}
